...
date: 2025-11-23
tags: [non-lucrative, retirement, visa, Spain]
image: /assets/img/logo.svg
faqs:
  - question: "How much money do I need for Spain's Non-Lucrative Visa in 2026?"
    answer: "You need to prove €2,400 per month (€28,800 annually) for the main applicant, plus €600 per month for each dependent. Additionally, you must show savings covering three years of expenses."
  - question: "Can I work in Spain on a Non-Lucrative Visa?"
    answer: "No. The Non-Lucrative Visa prohibits working or engaging in any professional activity in Spain. You can receive passive income from abroad, such as pensions, investments, or rental properties."
  - question: "How long is the Non-Lucrative Visa valid?"
    answer: "The initial visa is valid for one year. You can then renew it for two-year periods, and after five years you can apply for permanent residency."
  - question: "What happens if I spend less than 183 days per year in Spain?"
    answer: "You must spend at least 183 days per year in Spain to maintain tax residency and renew your visa. Spending less may jeopardize renewals and permanent residency eligibility."
---

## Table of contents
- [What is the Non-Lucrative Visa?](#what-is-the-non-lucrative-visa)
- [Who should apply for this visa](#who-should-apply-for-this-visa)
- [Income and financial requirements for 2026](#income-and-financial-requirements-for-2026)
- [Acceptable income sources](#acceptable-income-sources)
- [Healthcare requirements](#healthcare-requirements)
- [Complete document checklist](#complete-document-checklist)
- [Application process step-by-step](#application-process-step-by-step)
- [Processing times and costs](#processing-times-and-costs)
- [After arrival: registering in Spain](#after-arrival-registering-in-spain)
- [Tax implications and planning](#tax-implications-and-planning)
- [Bringing family members](#bringing-family-members)
- [Renewal requirements](#renewal-requirements)
- [Path to permanent residency and citizenship](#path-to-permanent-residency-and-citizenship)
...
1. **Completed visa application form**: National visa application (solicitud de visado nacional). Available from your Spanish consulate's website.

2. **Passport**: Valid for at least one year beyond your intended entry date, with at least two blank pages. Include photocopies of all pages.

3. **Passport photos**: Two recent color photos meeting biometric standards (35-40mm size, white background, frontal, no glasses).

4. **Criminal record certificate**: From your home country and any country where you've lived more than six months in the past five years. Must be apostilled and dated within three months of application. Translated into Spanish by official translator.

5. **Medical certificate**: From a licensed physician stating you're in good health and free from diseases with quarantine implications. Must be dated within three months of application, apostilled, and translated.

6. **Private health insurance**: Policy certificate in Spanish showing comprehensive coverage and no copays.

7. **Proof of income and savings**: Bank statements for the last six months, pension letters, investment account statements, property deeds for rental properties, and tax returns for the past two years. All apostilled and translated.

8. **Bank solvency certificate**: Official letter from your bank confirming account balances and good standing.

9. **Proof of accommodation**: Rental contract, property deed, or hotel booking in Spain for at least three months. If renting, include a letter from the property owner.

10. **Motivation letter**: One-page letter (in Spanish or English) explaining why you want to move to Spain and how you'll support yourself.

11. **Marriage certificate** (if applicable): Apostilled and translated.

12. **Birth certificates** (for dependent children): Apostilled and translated.

13. **Visa fee payment**: €60-160 depending on consulate. Some require payment at appointment; others require pre-payment.
...
Registration is usually instant, and you'll receive a certificate on the spot. For more details, see our [empadronamiento guide]({{ '/guides/empadronamiento-spain/' | relative_url }}).
