---
layout: post
title: "Unmarried Partner Visa Spain: Complete 2026 Guide for Couples"
description: "How the Unmarried Partner Visa Spain works in 2026. Official rules for Digital Nomad Visa, Non-Lucrative Visa, and family of Spanish nationals. Pareja de hecho registration and proof of stable partnership."
seo_title: "Unmarried Partner Visa Spain 2026 | Official DNV, NLV & Spanish Family Routes"
permalink: /guides/unmarried-partner-visa-spain-2026/
date: 2026-08-20
categories: guides
tags: ["unmarried partner visa spain", "pareja de hecho", "digital nomad visa spain", "non lucrative visa spain", "family reunification spain", "spain residency partner"]
image: /assets/images/blog/unmarried-partner-visa-spain-2026.jpg
reading_time: "14 min"
breadcrumbs:
  - name: Home
    url: /
  - name: Blog
    url: /blog/
  - name: Unmarried Partner Visa Spain
    url: /guides/unmarried-partner-visa-spain-2026/
faqs:
  - question: "Does the Unmarried Partner Visa Spain exist as a separate category?"
    answer: "No single visa carries that exact name. Spanish law recognises an unmarried partner through three main channels: as a family member of a Digital Nomad Visa holder, as a family member under the Non-Lucrative Visa, or as the registered or stable partner of a Spanish national under Real Decreto 1155/2024."
  - question: "How long must we cohabit for an unregistered partnership?"
    answer: "Real Decreto 1155/2024 states that a stable partnership is understood to exist when the couple proves continuous cohabitation analogous to marriage of at least twelve months, inside or outside Spain. Common children remove the twelve-month requirement provided the relationship continues."
  - question: "Can we register as pareja de hecho after arriving in Spain?"
    answer: "Yes. Many couples enter Spain, complete joint empadronamiento, and then register the partnership with the relevant autonomous-community register or before a notary. The resulting certificate supports the subsequent residence application."
  - question: "What income applies when adding an unmarried partner to the Digital Nomad Visa?"
    answer: "Consular guidance requires the main applicant to show 200 percent of the SMI. The first family member requires an additional 75 percent of the SMI and each further member 25 percent of the SMI."
  - question: "Is a home-country civil partnership accepted for the Unmarried Partner Visa Spain?"
    answer: "A registration in a public register of an EU Member State, an EEA country or Switzerland is treated as a registered partnership. Registrations from other countries are examined as evidence of a stable relationship and normally need supporting cohabitation proof."
---
...
## Table of Contents
- [The three official routes for an unmarried partner](#the-three-official-routes-for-an-unmarried-partner)
- [Digital Nomad Visa family members](#digital-nomad-visa-family-members)
- [Non-Lucrative Visa family members](#non-lucrative-visa-family-members)
- [Family of a Spanish national under Real Decreto 1155/2024](#family-of-a-spanish-national-under-real-decreto-11552024)
- [How to prove a stable unregistered partnership](#how-to-prove-a-stable-unregistered-partnership)
- [Regional requirements for pareja de hecho registration](#regional-requirements-for-pareja-de-hecho-registration)
- [Documents you must prepare](#documents-you-must-prepare)
- [Practical sequence that works for most couples](#practical-sequence-that-works-for-most-couples)
- [FAQs](#faqs)
...
1. Decide which residence route fits your situation (Digital Nomad, Non-Lucrative or Spanish-national family).  
2. Gather civil-status certificates and begin building the cohabitation file if the partnership is unregistered.  
3. Enter Spain under the appropriate entry conditions.  
4. Complete joint empadronamiento.  
5. Register the partnership with the regional register or before a notary if that strengthens the file.  
6. File the partner’s residence application with the supporting relationship evidence and the economic proof required by the chosen route.
...
Need a clear timeline for your specific documents and region? [Book a 30-minute strategy call with JuroSpain](/contact/) and we will map the exact sequence.

---

*This guide reflects Real Decreto 1155/2024, consular instructions published on exteriores.gob.es, and the official regional rules for pareja de hecho registration as of 20 August 2026. Requirements can change. Always verify the current text with the competent Spanish authority before filing.*
