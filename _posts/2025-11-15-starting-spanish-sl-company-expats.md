...
date: 2025-11-15
categories: guides
tags: ["Company formation", "Entrepreneurs", "Spain expats"]
...
breadcrumbs:
  ...
  - name: Company Formation Guide
    url: /guides/starting-spanish-sl-company-expats/
---
...
## Table of contents
- [SL vs. Autónomo: which is best?](#sl-vs-autonomo-which-is-best)
- [Pre-incorporation requirements](#pre-incorporation-requirements)
- [Reserving the company name](#reserving-the-company-name)
- [Depositing share capital](#depositing-share-capital)
- [Signing the notary deed](#signing-the-notary-deed)
- [Tax and Social Security registrations](#tax-and-social-security-registrations)
- [Ongoing compliance obligations](#ongoing-compliance-obligations)
- [FAQs](#faqs)
...
**Can I form an SL remotely?**
Yes. Grant a power of attorney to a Spanish representative and sign documents electronically when allowed by the notary.

**Do I need a Spanish bank account?**
Yes. Share capital must be deposited in a local bank or certified via an asset appraisal.

**How long does incorporation take?**
Expect 2–4 weeks if paperwork is complete and bank compliance checks are satisfied.
