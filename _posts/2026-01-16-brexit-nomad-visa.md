...
date: 2026-01-17
tags: [digital nomad visa, uk expats, spain residency, legal fees]
image: /assets/img/uk-spain-dnv.svg
faqs:
  - question: "Can I use a standard DBS check for the Spanish DNV?"
    answer: "No. Spanish immigration strictly requires the ACRO Police Certificate. A basic or enhanced DBS check will be rejected immediately, forcing you to restart the process and lose your application fee."
  - question: "Do I still need to pay UK National Insurance?"
    answer: "It depends. If you obtain the A1 Certificate from HMRC, you can remain in the UK system for up to 2 years. Without it, you must register as 'Autónomo' in Spain and pay Spanish Social Security (approx €300/month after the first year)."
  - question: "Is it faster to apply from London or within Spain?"
    answer: "Applying from within Spain (during your 90-day tourist stay) is significantly faster. The UGE-CE in Madrid typically resolves applications in 20 business days, whereas the Spanish Consulate in London is currently facing backlogs of 3-4 months."
---
...
Paying a lawyer seems expensive until you calculate the cost of a rejection:
